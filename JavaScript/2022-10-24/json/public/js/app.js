...
function createDom(movies) {
  var baseContainer = document.querySelector('.container');
  var divFilmsWrapper = document.createElement('div');
  divFilmsWrapper.classList.add('films-wrapper');
  baseContainer.appendChild(divFilmsWrapper);
  movies.map(function (movie, index) {
    var divOneFilm = document.createElement('div');
    divOneFilm.classList.add('film', "film-index-".concat(index));
    ...
    var liShortInfo = document.createElement('li');
    ...
    var outputGenre = movie.genre.toString().split(',').join(', ');
    liGenre.textContent = 'Genre: ' + outputGenre;
    ul.appendChild(liGenre);
    var liRating = document.createElement('li');
    liRating.textContent = "Rating score: ".concat(movie.rating.ratingScore, "; Rating voters: ").concat(movie.rating.numberOfVoters);
    ...
    var actors = [];
    movie.majorActors.map(function (actor) {
